  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-xl mx-auto">
        ...
        >
          {user ? "Přidat tip" : "Přihlásit se a přidat tip"}
        </button>

        {!user && (
          <p className="text-center text-xs text-gray-400">
            Pro přidání tipu je potřeba se přihlásit.{" "}
            <Link href="/" className="underline hover:text-gray-600">Zpět na tipy</Link>
          </p>
        )}
      </form>
    </>
